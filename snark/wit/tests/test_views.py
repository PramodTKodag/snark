...
class TestWitViews:
    ...
    def test_no_endpoint(self, mock_gen):
        ...
        resp = self.client.get("/v1/wit/no/")
    ...
    def test_excuse_endpoint(self, mock_gen):
        ...
        resp = self.client.get("/v1/wit/excuse/")
        assert resp.status_code == 200
    ...
    def test_blame_endpoint(self, mock_gen):
        ...
        resp = self.client.get("/v1/wit/blame/")
        assert resp.status_code == 200
    ...
    def test_eli5_endpoint(self, mock_gen):
        ...
        resp = self.client.get("/v1/wit/eli5/", {"q": "kubernetes"})
        assert resp.status_code == 200

    def test_eli5_missing_q(self):
        resp = self.client.get("/v1/wit/eli5/")
        assert resp.status_code == 400
