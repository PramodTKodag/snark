...
urlpatterns = [
    ...
    path("corporate-jargon/", CorporateJargonView.as_view(), name="wit-corporate-jargon"),
    ...
    path("explain-like-im-5/", ExplainLikeIm5View.as_view(), name="wit-explain-like-im-5"),
    ...
    path("jargon-translator/", JargonTranslatorView.as_view(), name="wit-jargon-translator"),
    path("incident-postmortem/", IncidentPostmortemView.as_view(), name="wit-incident-postmortem"),
    # New endpoints
    ...
    path("interview-question/", InterviewQuestionView.as_view(), name="wit-interview-question"),
    path("honest-changelog/", HonestChangelogView.as_view(), name="wit-honest-changelog"),
