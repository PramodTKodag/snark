...
CMD ["sh", "-c", "cd snark && python manage.py migrate && python manage.py ensure_admin && gunicorn base.wsgi:application --bind 0.0.0.0:8094 --workers 2 --threads 2 --max-requests 1000 --max-requests-jitter 100 --timeout 120"]
